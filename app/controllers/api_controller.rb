...
class ApiController < ApplicationController
    ...
    def update_prices
     ...
     Product.all.each do |product|
      ...
      product.price = 16546*5 if product.sku == "6"
      ...
      product.price = 9768*5 if product.sku == "41"
      product.price = 1803*5 if product.sku == "49"
      product.save!
     end

     Spree::Product.all.each do |product|
      product.price = 184 if product.name == "Huevo"
      product.price = 16546*5 if product.name == "Crema"
      ...
      product.price = 9768*5 if product.name == "Suero de Leche"
      product.price = 1803*5 if product.name == "Leche Descremada"
      product.save!
     end
